...
namespace Games.DataAccess.Migrations
{
    ...
    [Migration("20240103224945_addShoppingCartDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Games.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Games.Models.ShoppingCart", b =>
                {
                    b.HasOne("Games.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
                        .HasForeignKey("ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Games.Models.Product", "Product")
                        .WithMany()
